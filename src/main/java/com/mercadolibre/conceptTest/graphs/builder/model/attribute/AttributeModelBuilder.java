...
import com.mercadolibre.service.impl.DefaultCategoryAttributeService;
...
public class AttributeModelBuilder {
    ...
    protected Boolean isNullOrEmptyAttributeList(List<CategoryAttribute> categoryAttributes) {
        return categoryAttributes == null || categoryAttributes.isEmpty();
    }
